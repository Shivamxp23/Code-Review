...
const config: DashboardViteConfig = {
  ...
  resolve: {
    alias: {
      "@reviewer/core/schema": path.resolve(__dirname, "../core/dist/schema.js"),
      "@reviewer/core/search": path.resolve(__dirname, "../core/dist/search.js"),
      "@reviewer/core/types": path.resolve(__dirname, "../core/dist/types.js"),
    },
  },
